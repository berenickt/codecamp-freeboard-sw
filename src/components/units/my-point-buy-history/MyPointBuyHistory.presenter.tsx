...
import * as S from './MyPointBuyHistory.styles'
...
export default function MyPointBuyHistoryUI(props: any) {
  return (
    <S.FlexWrapper>
      <MyPageSideBar />
      <S.Section>
        ...
        {props.data?.fetchPointTransactionsOfBuying.map((element: any) => (
