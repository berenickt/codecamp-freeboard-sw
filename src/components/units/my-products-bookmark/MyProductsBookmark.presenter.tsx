...
import * as S from './MyProductsBookmark.styles'
import { IMyProductsBookmarkUIProps } from './MyProductsBookmark.types'
...
export default function MyProductsBookmarkUI(props: IMyProductsBookmarkUIProps) {
  ...
  return (
    <S.FlexWrapper>
      ...
      <S.Section>
        ...
        {props.data?.fetchUseditemsIPicked.map(element => (
