...
import * as S from './MyPointChargeHistory.styles'
...
export default function MyPointChargeHistoryUI(props: any) {
  return (
    <S.FlexWrapper>
      <MyPageSideBar />
      <S.Section>
        ...
        {props.data?.fetchPointTransactionsOfLoading.map((element: any) => (
