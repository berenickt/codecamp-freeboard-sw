...
import SearchDateUI from './SearchDate.presenter'

export default function SearchDate(props: any) {
  ...
  // **** 검색 입력값 받기
  function onChangeDateSearchbar(event: any) {
    getDebounce(event.target.value)
  }

  return <SearchDateUI onChangeDateSearchbar={onChangeDateSearchbar} />
}
